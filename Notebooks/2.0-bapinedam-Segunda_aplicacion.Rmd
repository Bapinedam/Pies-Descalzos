---
title: "Análisis de resultados: Segunda aplicación"
output: 
  pdf_document:
    toc: yes
    toc_depth: 5
...
set.seed(321)
# rmarkdown::render(input="1.0-bapinedam-segunda_aplicacion.Rmd",
...
url_pre = paste("https://docs.google.com/spreadsheets/d/",
                "1nmTecdohkKDNcppMfIXT0yrmKnoxIg-ZQZHuIOg3LBA/edit#gid=878062551",
                sep = "")
```
...
url_post = paste("https://docs.google.com/spreadsheets/d/",
                 "1n69qyde6BSUWVV5jSv3-sbCRF_gWyErPwatNAqKG9vo/edit#gid=878062551",
                 sep = "")
```
...
actitudes_pre = actitudes_pre[,1:18]

col_items = paste(rep("Grupo", 12), rep(1:4, each = 3), rep(paste("_", rep(1:3, 3))))
...
actitudes_pre[,7:18] = apply(actitudes_pre[,7:18], 2, function(x) str_to_upper(x))

claves_lenguaje_pre = c('B','A','A','B','B','A','A','A','B','B','A','B') 

claves_matematicas_pre  = c('B','A','A','B','A','A','A','B','B','A','A','B') 
...
actitudes_post = actitudes_post[,1:18]
...
actitudes_post[,7:18] = apply(actitudes_post[,7:18], 2, function(x) as.character(x))
...
actitudes_post[,7:18] = apply(actitudes_post[,7:18], 2, function(x) str_to_upper(x))


claves_lenguaje_post = c('A','A','B','B','B','B','B','A','A','A','B','A') 

claves_matematicas_post  = c('B','A','A','A','A','B','A','A','B','B','A','B') 
...
```{r}
# Calificación pre
actitudes_lenguaje_pre[,7:18] = calificacion(actitudes_lenguaje_pre[,7:18],
                                              claves_lenguaje_pre)

# Calificación post
actitudes_lenguaje_post[,7:18] = calificacion(actitudes_lenguaje_post[,7:18],
                                              claves_lenguaje_post)
```
...
actitudes_lenguaje_pre$Total_pre = apply(actitudes_lenguaje_pre[,7:18], 1, 
                                         function(x) sum(x, na.rm= FALSE))

actitudes_lenguaje_post$Total_post = apply(actitudes_lenguaje_post[,7:18], 1, 
                                           function(x) sum(x, na.rm= FALSE))

# Afectivo

actitudes_lenguaje_pre$Afectivo_pre = apply(actitudes_lenguaje_pre[,c(7, 10, 13, 16)], 1,
                                            function(x) sum(x, na.rm= FALSE))
actitudes_lenguaje_post$Afectivo_post = apply(actitudes_lenguaje_post[,c(7, 10, 13, 16)], 1,
                                              function(x) sum(x, na.rm= FALSE))

# Cognitivo

actitudes_lenguaje_pre$Cognitivo_pre = apply(actitudes_lenguaje_pre[,c(8, 11, 14, 17)], 1,
                                             function(x) sum(x, na.rm= FALSE))
actitudes_lenguaje_post$Cognitivo_post = apply(actitudes_lenguaje_post[,c(8, 11, 14, 17)], 1,
                                               function(x) sum(x, na.rm= FALSE))

# Conativo

actitudes_lenguaje_pre$Conativo_pre = apply(actitudes_lenguaje_pre[,c(9, 12, 15, 18)], 1,
                                            function(x) sum(x, na.rm= FALSE))
actitudes_lenguaje_post$Conativo_post = apply(actitudes_lenguaje_post[,c(9, 12, 15, 18)], 1,
                                              function(x) sum(x, na.rm= FALSE))
...
```{r}
alpha(actitudes_lenguaje_pre[,7:18])

for(i in seq(length(colnames(actitudes_lenguaje_pre[,7:18])))){
    x = alpha(actitudes_lenguaje_pre[,7:18][,-i])
    print(paste("El índice de confiabilidad cambia a", round(x, 2), 
                "al eliminar el ítem",
                colnames(actitudes_lenguaje_pre[,7:18])[i]))
}
```
...
```{r}
alpha(actitudes_lenguaje_post[,7:18])

for(i in seq(length(colnames(actitudes_lenguaje_post[,7:18])))){
    x = alpha(actitudes_lenguaje_post[,7:18][,-i])
    print(paste("El índice de confiabilidad cambia a", round(x, 2), 
                "al eliminar el ítem",
                colnames(actitudes_lenguaje_post[,7:18])[i]))
}
```
...
```{r}
alpha(actitudes_lenguaje_pre[,c(8, 11, 14, 17)])

for(i in seq(length(colnames(actitudes_lenguaje_pre[,c(8, 11, 14, 17)])))){
  x = alpha(actitudes_lenguaje_pre[,c(8, 11, 14, 17)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_lenguaje_pre[,c(8, 11, 14, 17)])[i]))
}
```
...
```{r}
alpha(actitudes_lenguaje_post[,c(8, 11, 14, 17)])
for(i in seq(length(colnames(actitudes_lenguaje_post[,c(8, 11, 14, 17)])))){
  x = alpha(actitudes_lenguaje_post[,c(8, 11, 14, 17)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_lenguaje_post[,c(8, 11, 14, 17)])[i]))
}
```
...
```{r}
alpha(actitudes_lenguaje_pre[,c(7, 10, 13, 16)])

for(i in seq(length(colnames(actitudes_lenguaje_pre[,c(7, 10, 13, 16)])))){
  x = alpha(actitudes_lenguaje_pre[,c(7, 10, 13, 16)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_lenguaje_pre[,c(7, 10, 13, 16)])[i]))
}
```
...
```{r}
alpha(actitudes_lenguaje_post[,c(7, 10, 13, 16)])

for(i in seq(length(colnames(actitudes_lenguaje_post[,c(7, 10, 13, 16)])))){
  x = alpha(actitudes_lenguaje_post[,c(7, 10, 13, 16)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_lenguaje_post[,c(7, 10, 13, 16)])[i]))
}
```
...
```{r}
alpha(actitudes_lenguaje_pre[,c(9, 12, 15, 18)])

for(i in seq(length(colnames(actitudes_lenguaje_pre[,c(9, 12, 15, 18)])))){
  x = alpha(actitudes_lenguaje_pre[,c(9, 12, 15, 18)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_lenguaje_pre[,c(9, 12, 15, 18)])[i]))
}
```
...
```{r}
alpha(actitudes_lenguaje_post[,c(9, 12, 15, 18)])

for(i in seq(length(colnames(actitudes_lenguaje_post[,c(9, 12, 15, 18)])))){
  x = alpha(actitudes_lenguaje_post[,c(9, 12, 15, 18)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_lenguaje_post[,c(9, 12, 15, 18)])[i]))
}
```
...
```{r, warning=FALSE}
analitem = item.exam(actitudes_lenguaje_pre[,7:18], discrim=T)
...
```{r, warning=FALSE}
analitem = item.exam(actitudes_lenguaje_post[,7:18], discrim=T)
analitem = dplyr::select(analitem, -c("Item.Criterion", "Item.Validity")) 
cols_num = colnames(analitem[,1:6])
analitem$Item = row.names(analitem)
analitem[,1:6] %>%
...
ggsave("../Plots/segunda_aplicacion/actitudes_lenguaje.png")
```
...
ggsave("../Plots/segunda_aplicacion/actitudes_lenguaje_afectivo.png")
```
...
ggsave("../Plots/segunda_aplicacion/actitudes_lenguaje_cognitivo.png")
```
...
ggsave("../Plots/segunda_aplicacion/actitudes_lenguaje_conativo.png")
```
...
actitudes_matematicas_pre[,7:18] =
  calificacion(actitudes_matematicas_pre[,7:18], 
               claves_matematicas_pre)

# Calificación post
actitudes_matematicas_post[,7:18] =
  calificacion(actitudes_matematicas_post[,7:18], 
               claves_matematicas_post)
```
...
actitudes_matematicas_pre$Total_pre =
  apply(actitudes_matematicas_pre[,7:18], 1, 
        function(x) sum(x, na.rm= FALSE))

actitudes_matematicas_post$Total_post =
  apply(actitudes_matematicas_post[,7:18], 1, 
        function(x) sum(x, na.rm= FALSE))

# Afectivo

actitudes_matematicas_pre$Afectivo_pre =
  apply(actitudes_matematicas_pre[,c(7, 10, 13, 16)], 1, 
        function(x) sum(x, na.rm= FALSE))

actitudes_matematicas_post$Afectivo_post =
  apply(actitudes_matematicas_post[,c(7, 10, 13, 16)], 1, 
        function(x) sum(x, na.rm= FALSE))

# Cognitivo

actitudes_matematicas_pre$Cognitivo_pre =
  apply(actitudes_matematicas_pre[,c(8, 11, 14, 17)], 1, 
        function(x) sum(x, na.rm= FALSE))

actitudes_matematicas_post$Cognitivo_post =
  apply(actitudes_matematicas_post[,c(8, 11, 14, 17)], 1, 
        function(x) sum(x, na.rm= FALSE))

# Conativo

actitudes_matematicas_pre$Conativo_pre =
  apply(actitudes_matematicas_pre[,c(9, 12, 15, 18)], 1, 
        function(x) sum(x, na.rm= FALSE))

actitudes_matematicas_post$Conativo_post =
  apply(actitudes_matematicas_post[,c(9, 12, 15, 18)], 1, 
        function(x) sum(x, na.rm= FALSE))
...
```{r}
alpha(actitudes_matematicas_pre[,7:18])

for(i in seq(length(colnames(actitudes_matematicas_pre[,7:18])))){
  x = alpha(actitudes_matematicas_pre[,7:18][,-i])
  print(paste("El índice de confiabilidad cambia a", x, 
              "al eliminar el ítem",
              colnames(actitudes_matematicas_pre[,7:18])[i]))
}
```
...
```{r}
alpha(actitudes_matematicas_post[,7:18])

for(i in seq(length(colnames(actitudes_matematicas_post[,7:18])))){
  x = alpha(actitudes_matematicas_post[,7:18][,-i])
  print(paste("El índice de confiabilidad cambia a", x, 
              "al eliminar el ítem",
              colnames(actitudes_matematicas_post[,7:18])[i]))
}
```
...
```{r}
alpha(actitudes_matematicas_pre[,c(8, 11, 14, 17)])

for(i in seq(length(colnames(actitudes_matematicas_pre[,c(8, 11, 14, 17)])))){
  x = alpha(actitudes_matematicas_pre[,c(8, 11, 14, 17)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_matematicas_pre[,c(8, 11, 14, 17)])[i]))
}
```
...
```{r}
alpha(actitudes_matematicas_post[,c(8, 11, 14, 17)])
for(i in seq(length(colnames(actitudes_matematicas_post[,c(8, 11, 14, 17)])))){
  x = alpha(actitudes_matematicas_post[,c(8, 11, 14, 17)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_matematicas_post[,c(8, 11, 14, 17)])[i]))
}
```
...
```{r}
alpha(actitudes_matematicas_pre[,c(7, 10, 13, 16)])

for(i in seq(length(colnames(actitudes_matematicas_pre[,c(7, 10, 13, 16)])))){
  x = alpha(actitudes_matematicas_pre[,c(7, 10, 13, 16)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_matematicas_pre[,c(7, 10, 13, 16)])[i]))
}
```
...
```{r}
alpha(actitudes_matematicas_post[,c(7, 10, 13, 16)])

for(i in seq(length(colnames(actitudes_matematicas_post[,c(7, 10, 13, 16)])))){
  x = alpha(actitudes_matematicas_post[,c(7, 10, 13, 16)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_matematicas_post[,c(7, 10, 13, 16)])[i]))
}
```
...
```{r}
alpha(actitudes_matematicas_pre[,c(9, 12, 15, 18)])

for(i in seq(length(colnames(actitudes_matematicas_pre[,c(9, 12, 15, 18)])))){
  x = alpha(actitudes_matematicas_pre[,c(9, 12, 15, 18)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_matematicas_pre[,c(9, 12, 15, 18)])[i]))
}
```
...
```{r}
alpha(actitudes_matematicas_post[,c(9, 12, 15, 18)])

for(i in seq(length(colnames(actitudes_matematicas_post[,c(9, 12, 15, 18)])))){
  x = alpha(actitudes_matematicas_post[,c(9, 12, 15, 18)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, "al eliminar el ítem",
              colnames(actitudes_matematicas_post[,c(9, 12, 15, 18)])[i]))
}
```
...
```{r}
analitem = item.exam(actitudes_matematicas_pre[,7:18], discrim=T)
analitem = dplyr::select(analitem, -c("Item.Criterion", "Item.Validity")) 
cols_num = colnames(analitem[,1:6])
analitem$Item = row.names(analitem)
analitem[,1:6] %>%
...
```{r}
analitem = item.exam(actitudes_matematicas_post[,7:18], discrim=T)
analitem = dplyr::select(analitem, -c("Item.Criterion", "Item.Validity")) 
cols_num = colnames(analitem[,1:6])
analitem$Item = row.names(analitem)
analitem[,1:6] %>%
...
Debido a que el ítem *Grupo 3 _ 1* tiene un comportamiento psicométrico indeseado, será eliminado de la calificación. Dicho ítem pertenece al componente afectivo.
...
actitudes_matematicas_pre$Total_pre =
  apply(actitudes_matematicas_pre[,c(7:18)[-7]], 1, 
        function(x) sum(x, na.rm= FALSE))

actitudes_matematicas_post$Total_post =
  apply(actitudes_matematicas_post[,c(7:18)[-7]], 1, 
        function(x) sum(x, na.rm= FALSE))

# Afectivo

actitudes_matematicas_pre$Afectivo_pre =
  apply(actitudes_matematicas_pre[,c(7, 10, 16)], 1, 
        function(x) sum(x, na.rm= FALSE))
...
claves_motivacion_pre = c('B','A','A','B','B','B','B','B','A','A')
...
claves_motivacion_post = c('B','B','A','B','A','A','B','B','A','A')
...
motivacion_pre$Interes_pre = apply(motivacion_pre[,c(7,10,13)], 1, 
                                   function(x) sum(x, na.rm= FALSE))

motivacion_post$Interes_post = apply(motivacion_post[,c(8,11,14)], 1, 
                                     function(x) sum(x, na.rm= FALSE))
...
motivacion_pre$OrientacionAprendizaje_pre = 
  apply(motivacion_pre[,c(8,11,15)], 1,
        function(x) sum(x, na.rm= FALSE))

motivacion_post$OrientacionAprendizaje_post =
  apply(motivacion_post[,c(9,12,15)], 1,
        function(x) sum(x, na.rm= FALSE))
...
motivacion_pre$AtribucionInterna_pre = 
  apply(motivacion_pre[,c(9,16)], 1, 
        function(x) sum(x, na.rm= FALSE))

motivacion_post$AtribucionInterna_post = 
  apply(motivacion_post[,c(13,16)], 1, 
        function(x) sum(x, na.rm= FALSE))
...
motivacion_pre$Expectativa_pre = apply(motivacion_pre[,c(12, 14)], 1, 
                                       function(x) sum(x, na.rm= FALSE))

motivacion_post$Expectativa_post = apply(motivacion_post[,c(7, 10)], 1, 
                                         function(x) sum(x, na.rm= FALSE))
...
Como podemos observar los valores en el alpha son bastante bajo y se debe al ruido que están generando algunos ítems, sobre todo los relacionados con interés y atribución. Una combinación que satisface los indicadores es

#### Total pre

```{r}
alpha(motivacion_pre[,c(7:16)[-c(1, 7, 3, 4, 10)]])

for(i in seq(length(colnames(motivacion_pre[,c(7:16)[-c(1, 7, 3, 4, 10)]])))){
  x = alpha(motivacion_pre[,c(7:16)[-c(1, 7, 3, 4, 10)]][,-i])
  print(paste("El índice de confiabilidad cambia a", x, 
              "al eliminar el ítem", 
              colnames(motivacion_pre[,c(7:16)[-c(1, 7, 3, 4, 10)]])[i]))
}
```
...
```{r}
alpha(motivacion_post[,c(7:16)[-c(2, 5, 6, 10)]])

for(i in seq(length(colnames(motivacion_post[,c(7:16)[-c(2, 5, 6, 10)]])))){
  x = alpha(motivacion_post[,c(7:16)[-c(2, 5, 6, 10)]][,-i])
  print(paste("El índice de confiabilidad cambia a", x, 
              "al eliminar el ítem", 
              colnames(motivacion_post[,c(7:16)[-c(2, 5, 6, 10)]])[i]))
}
```
...
```{r}
alpha(motivacion_pre[,c(7,10,13)])

for(i in seq(length(colnames(motivacion_pre[,c(7,10,13)])))){
  x = alpha(motivacion_pre[,c(7,10,13)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, 
              "al eliminar el ítem", 
              colnames(motivacion_pre[,c(7,10,13)])[i]))
}
```
...
```{r}
alpha(motivacion_post[,c(8,11,14)])

for(i in seq(length(colnames(motivacion_post[,c(8,11,14)])))){
  x = alpha(motivacion_post[,c(8,11,14)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, 
              "al eliminar el ítem", 
              colnames(motivacion_post[,c(8,11,14)])[i]))
}
```
...
```{r}
alpha(motivacion_pre[,c(8,11,15)])

for(i in seq(length(colnames(motivacion_pre[,c(8,11,15)])))){
  x = alpha(motivacion_pre[,c(8,11,15)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, 
              "al eliminar el ítem", 
              colnames(motivacion_pre[,c(8,11,15)])[i]))
}
```
...
```{r}
alpha(motivacion_post[,c(9,12,15)])

for(i in seq(length(colnames(motivacion_post[,c(9,12,15)])))){
  x = alpha(motivacion_post[,c(9,12,15)][,-i])
  print(paste("El índice de confiabilidad cambia a", x, 
              "al eliminar el ítem", 
              colnames(motivacion_post[,c(9,12,15)])[i]))
}
```

#### Atribución interna pre

```{r}
alpha(motivacion_pre[,c(9,16)])
```

#### Atribución interna pre

```{r}
alpha(motivacion_post[,c(13,16)])
```
No puede obtener el indicador al eliminar un ítem, ya que si queda un único ítem el indicador no tiene solución.

#### Expectativa positiva pre

```{r}
alpha(motivacion_pre[,c(12,14)])
```

#### Expectativa positiva pre

```{r}
alpha(motivacion_post[,c(7,10)])
```
...
ggsave("../Plots/segunda_aplicacion/motivacion.png")
```
...
ggsave("../Plots/segunda_aplicacion/motivacion_interes.png")
```
...
lillie.test(pre_post$OrientacionAprendizaje_pre)


print("Estadístico de normalidad post")

lillie.test(pre_post$OrientacionAprendizaje_post)
```
...
```{r}
summ = data.frame(unclass(psych::describe(pre_post[,c("OrientacionAprendizaje_pre",
                                                      "OrientacionAprendizaje_post")])), 
                  check.names = FALSE, stringsAsFactors = FALSE) 

summ$vars = c("OrientacionAprendizaje_pre", "OrientacionAprendizaje_post")
...
comparacion = 
  wilcox.test(
    x           = pre_post$OrientacionAprendizaje_pre,
    y           = pre_post$OrientacionAprendizaje_post,
    alternative = "two.sided",
    mu          = 0,
    var.equal   = TRUE,
    paired      = TRUE,
...
```{r}
pre_post %>%
  dplyr::select(OrientacionAprendizaje_pre, OrientacionAprendizaje_post) %>%
  pivot_longer(cols = c(OrientacionAprendizaje_pre, OrientacionAprendizaje_post), 
               values_to = "value", 
               names_to = "Aplicación") %>%
  ggplot(aes(x = reorder(`Aplicación`, desc(`Aplicación`)), y = value)) +
  geom_violin(trim=FALSE) +
...
ggsave("../Plots/segunda_aplicacion/motivacion_metas_aprendizaje.png")
```
...
```{r}
size_effect = 
  cohen.d(pre_post$OrientacionAprendizaje_post, 
          pre_post$OrientacionAprendizaje_pre, paired = TRUE)
...
lillie.test(pre_post$AtribucionInterna_pre)


print("Estadístico de normalidad post")

lillie.test(pre_post$AtribucionInterna_post)
```
...
```{r}
summ = data.frame(unclass(psych::describe(pre_post[,c("AtribucionInterna_pre",
                                                      "AtribucionInterna_post")])), 
                  check.names = FALSE, stringsAsFactors = FALSE) 

summ$vars = c("AtribucionInterna_pre", "AtribucionInterna_post")
...
comparacion = 
  wilcox.test(
    x           = pre_post$AtribucionInterna_pre,
    y           = pre_post$AtribucionInterna_post,
    alternative = "two.sided",
    mu          = 0,
    var.equal   = TRUE,
    paired      = TRUE,
...
```{r}
pre_post %>%
  dplyr::select(AtribucionInterna_pre, AtribucionInterna_post) %>%
  pivot_longer(cols = c(AtribucionInterna_pre, AtribucionInterna_post), 
               values_to = "value", 
               names_to = "Aplicación") %>%
  ggplot(aes(x = reorder(`Aplicación`, desc(`Aplicación`)), y = value)) +
  geom_violin(trim=FALSE) +
...
ggsave("../Plots/segunda_aplicacion/motivacion_AtribucionInterna.png")
```
...
```{r}
size_effect = 
  cohen.d(pre_post$AtribucionInterna_post, 
          pre_post$AtribucionInterna_pre, paired = TRUE)
...
desc = summ[,1:10] %>%
        dplyr::select(c("n", "mean", "sd", "min", "max")) %>%
          mutate(Prueba = "Motivación - Atribución interna") %>%
          mutate(Area = "Motivación") %>%
          mutate(`Aplicación` = c("Pre", "Post"))
...
data_temp = 
  data.frame(Prueba = "Motivación - Atribución interna",
             `Media pre` = summ$mean[1],
             `Media post` = summ$mean[2],
             `p value` = comparacion$p.value,
             `D de cohen` = size_effect$estimate)
...
ggsave("../Plots/segunda_aplicacion/motivacion_expectativas.png")
```
...
incorrectos_2_pre = c("Mariposa", "Mono",	"Jirafa",	"Araña")

mem_audi_pre[,7:30] = apply(mem_audi_pre[,7:30], 2,
                      function(x) str_replace_all(x,'NULL', '0'))

mem_audi_pre$`Aciertos item 1_pre` = 
  apply(apply(mem_audi_pre[,item_1_pre], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_audi_pre$`Errores item 1_pre` =
  apply(apply(mem_audi_pre[,incorrectos_1_pre],
              2, function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))



mem_audi_pre$`Aciertos item 2_pre` = 
  apply(apply(mem_audi_pre[,item_2_pre], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_audi_pre$`Errores item 2_pre` =
  apply(apply(mem_audi_pre[,incorrectos_2_pre],
              2, function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))
...
mem_audi_pre$`Puntaje item 1_pre` = 
  apply(mem_audi_pre[,"Puntaje item 1_pre"], 1,
        function(x) change_to_zero(x))

mem_audi_pre$`Puntaje item 2_pre` = 
  apply(mem_audi_pre[,"Puntaje item 2_pre"], 1,
        function(x) change_to_zero(x))
...
item_1_post = c("Caballo","Gallina", "Conejo", 
                "Leopardo", "Serpiente", "Cerdo", "Cangrejo", "Leon")

item_2_post = c("Ballena", "Gato", "Abeja", 
                "Cebra", "Rana", "Cocodrilo", "Tortuga", "Iguana")

incorrectos_1_post = c("Cabra", "Avestruz",	"Hormiga", "Perro")
incorrectos_2_post = c("Toro", "Pulpo",	"Loro",	"Camello")

mem_audi_post[,7:30] = apply(mem_audi_post[,7:30], 2,
                      function(x) str_replace_all(x,c('NULL' =  '0',
                                                      'O' = '0')))

mem_audi_post$`Aciertos item 1_post` =
  apply(apply(mem_audi_post[,item_1_post], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_audi_post$`Errores item 1_post` =
  apply(apply(mem_audi_post[,incorrectos_1_post], 
              2, function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))


mem_audi_post$`Aciertos item 2_post` =
  apply(apply(mem_audi_post[,item_2_post], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_audi_post$`Errores item 2_post` =
  apply(apply(mem_audi_post[,incorrectos_2_post], 
              2, function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))
...
mem_audi_post$`Puntaje item 1_post` = 
  apply(mem_audi_post[,"Puntaje item 1_post"],
        1, function(x) change_to_zero(x))

mem_audi_post$`Puntaje item 2_post` = 
  apply(mem_audi_post[,"Puntaje item 2_post"],
        1, function(x) change_to_zero(x))
```
...
ggsave("../Plots/segunda_aplicacion/memoria_auditiva.png")
```
...
vector = c(colnames(mem_vis_pre)[1:6], as.vector(unlist(mem_vis_pre[1,][7:18])))
...
mem_vis_pre[,7:18] = apply(mem_vis_pre[,7:18], 2,
                      function(x) str_replace_all(x,'NULL', '0'))

item_1_pre = c("OFICINA","LAVANDERIA","CINE")
item_2_pre = c("BARCO","JUGUETES","ELECTRONICOS")

incorrectos_1_pre = c("GYM",	"TALLER",	"TIENDA")
incorrectos_2_pre = c("SALON BELLEZA", "AEROPUERTO", "IGLESIA")

mem_vis_pre$`Aciertos item 1_pre` = 
  apply(apply(mem_vis_pre[,item_1_pre], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_vis_pre$`Errores item 1_pre` =
  apply(apply(mem_vis_pre[,incorrectos_1_pre], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_vis_pre$`Aciertos item 2_pre` = 
  apply(apply(mem_vis_pre[,item_2_pre], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_vis_pre$`Errores item 2_pre` =
  apply(apply(mem_vis_pre[,incorrectos_2_pre], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))
...
mem_vis_pre$`Puntaje item 1_pre` = 
  apply(mem_vis_pre[,"Puntaje item 1_pre"], 1,
        function(x) change_to_zero(x))

mem_vis_pre$`Puntaje item 2_pre` = 
  apply(mem_vis_pre[,"Puntaje item 2_pre"], 1,
        function(x) change_to_zero(x))

## Post

mem_vis_post = read_sheet(url_post, sheet = "Memoria Vis")
vector = c(colnames(mem_vis_post)[1:6], as.vector(unlist(mem_vis_post[1,][7:18])))
...
mem_vis_post[,7:18] = apply(mem_vis_post[,7:18], 2,
                      function(x) str_replace_all(x,'NULL', '0'))

item_1_post = c("Campo",	"Colegio_",	"Noira")
item_2_post = c("Heladeria",		"Parque",	"Aeropuerto")

incorrectos_1_post = c("Iglesia","GYM","Zoo")
incorrectos_2_post = c("Bus stop","Playa","Frutas")

mem_vis_post$`Aciertos item 1_post` = 
  apply(apply(mem_vis_post[,item_1_post], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_vis_post$`Errores item 1_post` =
  apply(apply(mem_vis_post[,incorrectos_1_post],
              2, function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_vis_post$`Aciertos item 2_post` = 
  apply(apply(mem_vis_post[,item_2_post], 2,
              function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))

mem_vis_post$`Errores item 2_post` =
  apply(apply(mem_vis_post[,incorrectos_2_post],
              2, function(x) as.numeric(x)),
        1, function(x) sum(x, na.rm= FALSE))
...
mem_vis_post$`Puntaje item 1_post` = 
  apply(mem_vis_post[,"Puntaje item 1_post"], 1,
        function(x) change_to_zero(x))

mem_vis_post$`Puntaje item 2_post` = 
  apply(mem_vis_post[,"Puntaje item 2_post"], 1,
        function(x) change_to_zero(x))
```
...
```{r}
data_item_1_pre = apply(mem_vis_pre[,item_1_pre], 2, 
                        function(x) as.numeric(x))
```
...
```{r}
data_item_1_post = apply(mem_vis_post[,item_1_post], 2, 
                         function(x) as.numeric(x))
```
...
```{r}
data_item_2_post = apply(mem_vis_post[,item_2_post], 2, 
                         function(x) as.numeric(x))
```
...
ggsave("../Plots/segunda_aplicacion/memoria_visual.png")
```
...
inhibicion_pre = inhibicion_pre[,1:26]
...
claves_inhibicion_pre = c('N','M','M','N','M','N','M',
                          'N','M','N','N','M','N','M','N',
                          'M','M','N','M','N')


inhibicion_pre[,7:26] = calificacion(inhibicion_pre[,7:26], claves_inhibicion_pre)

inhibicion_pre$`Aciertos item 1_pre` =  apply(inhibicion_pre[,7:16], 1, 
                                              function(x) sum(x, na.rm= FALSE))

inhibicion_pre$`Aciertos item 2_pre` =  apply(inhibicion_pre[,17:26], 1, 
                                              function(x) sum(x, na.rm= FALSE))


# Post

inhibicion_post = read_sheet(url_post, sheet = "Inhibiciòn")
...
```{r}
data_item_2_pre = apply(inhibicion_pre[,17:26], 2, 
                        function(x) as.numeric(x))
```
...
```{r}
data_item_2_post = apply(inhibicion_post[,17:26], 2, 
                         function(x) as.numeric(x))
```
...
pre_post = inner_join(inhibicion_post, 
                      dplyr::select(inhibicion_pre, c("Código", 
                                                      "Total_pre")),
                      by = "Código")
```
...
ggsave("../Plots/segunda_aplicacion/inhibicion.png")
```
...
claves_flexibilidad_pre = c('A','M','N','A','N','M','M','N',
                            'A','A','N','3','M','M','3','N',
                            'N','M','3','3')


flexibilidad_pre[,7:26] = calificacion(flexibilidad_pre[,7:26],
                                       claves_flexibilidad_pre)

flexibilidad_pre$`Aciertos item 1_pre` =  
  apply(flexibilidad_pre[,7:16], 1,
        function(x) sum(x, na.rm= FALSE))

flexibilidad_pre$`Aciertos item 2_pre` =  
  apply(flexibilidad_pre[,17:26], 1,
        function(x) sum(x, na.rm= FALSE))
...
claves_flexibilidad_post = c('H','S','E','E','H','S','H','E','H','S','S',
                             '3','E','E','3','S','S','3','E','S')

flexibilidad_post[,7:26] = calificacion(flexibilidad_post[,7:26],
                                        claves_flexibilidad_post)

flexibilidad_post$`Aciertos item 1_post` =  
  apply(flexibilidad_post[,7:16], 1,
        function(x) sum(x, na.rm= FALSE))

flexibilidad_post$`Aciertos item 2_post` =  
  apply(flexibilidad_post[,17:26], 1,
        function(x) sum(x, na.rm= FALSE))
```
...
```{r}
alpha(flexibilidad_pre[,17:26])

for(i in seq(length(colnames(flexibilidad_pre[,17:26])))){
  x = alpha(flexibilidad_pre[,17:26][,-i])
  print(paste("El índice de confiabilidad cambia a", x, 
              "al eliminar el ítem", 
              colnames(flexibilidad_pre[,17:26])[i]))
}
```
...
```{r}
analitem = item.exam(flexibilidad_pre[,17:26], discrim=T)
analitem = dplyr::select(analitem, -c("Item.Criterion", "Item.Validity")) 
cols_num = colnames(analitem[,1:6])
analitem$Item = row.names(analitem)
analitem[,1:6] %>%
...
pre_post = inner_join(flexibilidad_post, 
                      dplyr::select(flexibilidad_pre, c("Código",
                                                        "Total_pre")),
                      by = "Código")
```
...
ggsave("../Plots/segunda_aplicacion/flexibilidad.png")
```
...
socioemocional_pre = socioemocional_pre[,1:15]
...
socioemocional_pre[,7:15] = apply(socioemocional_pre[,7:15], 2, 
                                  function(x) str_to_upper(x))
...
socioemocional_post = socioemocional_post[,1:15]
...
socioemocional_post[,7:15] = apply(socioemocional_post[,7:15], 2, 
                                   function(x) str_to_upper(x))
...
socio_reconocimiento_pre = as_tibble(socioemocional_pre) %>%
  dplyr::select(`Código`,"3", "5", "7")


claves_reconocimiento_pre = c("A", "C", "A")

socio_reconocimiento_pre[,2:4] = 
  calificacion(data = socio_reconocimiento_pre[,2:4],
               claves = claves_reconocimiento_pre)

socio_reconocimiento_pre[,2:4] = 
  as.data.frame(apply(socio_reconocimiento_pre[,2:4],
                      2, function(x) as.numeric(x)))

# Post

socio_reconocimiento_post = as_tibble(socioemocional_post) %>%
  dplyr::select(`Código`, "4", "6", "7")


claves_reconocimiento_post = c("A", "C", "B")

socio_reconocimiento_post[,2:4] = 
  calificacion(data = socio_reconocimiento_post[,2:4],
               claves = claves_reconocimiento_post)

socio_reconocimiento_post[,2:4] =
  as.data.frame(apply(socio_reconocimiento_post[,2:4], 2, 
                      function(x) as.numeric(x)))
...
regulacion_pre = as_tibble(socioemocional_pre) %>%
  dplyr::select(`Código`, "1", "4", "8")


regulacion_pre$`1` = str_replace_all(regulacion_pre$`1`, 
                                      c("A" = "1", "B" = "1",
                                        "C" = "0", "D" = "0",
                                        "X" = "", "O" = ""))

regulacion_pre$`4` = str_replace_all(regulacion_pre$`4`, 
                                      c("A" = "1", "B" = "0",
                                        "C" = "0", "D" = "1",
                                        "X" = "", "O" = ""))

regulacion_pre$`8`= str_replace_all(regulacion_pre$`8`, 
                                      c("A" = "1", "B" = "1",
                                        "C" = "0", "D" = "0",
                                        "X" = "", "O" = ""))
...
regulacion_post = as_tibble(socioemocional_post) %>%
  dplyr::select(`Código`, "1", "3", "8")


regulacion_post$`1` = str_replace_all(regulacion_post$`1`, 
                                      c("A" = "0", "B" = "0",
                                        "C" = "1", "D" = "1",
                                        "X" = "", "O" = ""))

regulacion_post$`3` = str_replace_all(regulacion_post$`3`, 
                                      c("A" = "1", "B" = "1",
                                        "C" = "0", "D" = "0",
                                        "X" = "", "O" = ""))

regulacion_post$`8`= str_replace_all(regulacion_post$`8`, 
                                      c("A" = "0", "B" = "1",
                                        "C" = "0", "D" = "1",
                                        "X" = "", "O" = ""))
...
expresion_pre = as_tibble(socioemocional_pre) %>%
  dplyr::select(`Código`, "2", "6", "9")


expresion_pre$`2` = str_replace_all(expresion_pre$`2`, 
                                   c("A" = "0", "B" = "1",
                                     "C" = "1", "D" = "0",
                                     "X" = "", "O" = ""))

expresion_pre$`6` = str_replace_all(expresion_pre$`6`, 
                                   c("A" = "1", "B" = "1",
                                     "C" = "0", "D" = "0",
                                     "X" = "", "O" = ""))

expresion_pre$`9` = str_replace_all(expresion_pre$`9`, 
                                    c("A" = "1", "B" = "0",
                                      "C" = "0", "D" = "1",
                                      "X" = "", "O" = ""))
...
expresion_post = as_tibble(socioemocional_post) %>%
  dplyr::select(`Código`, "2", "5", "9")


expresion_post$`2` = str_replace_all(expresion_post$`2`, 
                                   c("A" = "0", "B" = "1",
                                     "C" = "0", "D" = "1",
                                     "X" = "", "O" = ""))

expresion_post$`5` = str_replace_all(expresion_post$`5`, 
                                   c("A" = "1", "B" = "0",
                                     "C" = "0", "D" = "1",
                                     "X" = "", "O" = ""))

expresion_post$`9` = str_replace_all(expresion_post$`9`, 
                                    c("A" = "1", "B" = "0",
                                      "C" = "0", "D" = "1",
                                      "X" = "", "O" = ""))
...
pre_post = inner_join(regulacion_post, 
                      dplyr::select(regulacion_pre, c("Código", 
                                                      "Total_pre")),
                      by = "Código")
```
...
ggsave("../Plots/segunda_aplicacion/socioemocionales_regulacion.png")
```
...
ggsave("../Plots/segunda_aplicacion/socioemocionales_reconocimiento.png")
```
...
ggsave("../Plots/segunda_aplicacion/socioemocionales_expresion.png")
```
...
write.xlsx(drop_na(alfa), "../Data/processed/segunda_aplicacion/alfa.xlsx", row.names = FALSE)
```
...
write.xlsx(descriptivos, "../Data/processed/segunda_aplicacion/descriptivos.xlsx", row.names = FALSE)
```
...
write.xlsx(indicadores_psicometricos,
           "../Data/processed/segunda_aplicacion/indicadores_psicometricos.xlsx",
           row.names = FALSE)
```
...
write.xlsx(comparaciones,
           "../Data/processed/segunda_aplicacion/pruebas_pre_post.xlsx",
           row.names = FALSE)
```
...
ggsave("../Plots/segunda_aplicacion/pruebas_significativas.png")
```
...
ggsave("../Plots/segunda_aplicacion/significativas_lenguaje.png")
```
...
ggsave("../Plots/segunda_aplicacion/significativas_matematicas.png")
```
...
ggsave("../Plots/segunda_aplicacion/significativas_motivacion.png")
```
...
ggsave("../Plots/segunda_aplicacion/significativas_ejecutivas.png")
```
...
ggsave("../Plots/segunda_aplicacion/significativas_socioemocionales.png")
```
...
ggsave("../Plots/segunda_aplicacion/significativas_ciudades.png")
```
...
ggsave("../Plots/segunda_aplicacion/significativas_ciclos.png")
```
