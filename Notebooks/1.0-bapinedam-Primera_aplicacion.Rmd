...
ggsave("../Plots/primera_aplicacion/actitudes_lenguaje.png")
```
...
ggsave("../Plots/primera_aplicacion/actitudes_lenguaje_afectivo.png")
```
...
ggsave("../Plots/primera_aplicacion/actitudes_lenguaje_cognitivo.png")
```
...
ggsave("../Plots/primera_aplicacion/actitudes_lenguaje_conativo.png")
```
...
ggsave("../Plots/primera_aplicacion/actitudes_matematicas.png")
```
...
ggsave("../Plots/primera_aplicacion/actitudes_matematicas_afectivo.png")
```
...
ggsave("../Plots/primera_aplicacion/actitudes_matematicas_cognitivo.png")
```
...
ggsave("../Plots/primera_aplicacion/actitudes_matematicas_conativo.png")
```
...
ggsave("../Plots/primera_aplicacion/motivacion.png")
```
...
ggsave("../Plots/primera_aplicacion/motivacion_interes.png")
```
...
ggsave("../Plots/primera_aplicacion/motivacion_metas_resultado.png")
```
...
ggsave("../Plots/primera_aplicacion/motivacion_AtribucionExterna.png")
```
...
ggsave("../Plots/primera_aplicacion/motivacion_expectativas.png")
```
...
ggsave("../Plots/primera_aplicacion/memoria_auditiva.png")
```
...
ggsave("../Plots/primera_aplicacion/memoria_visual.png")
```
...
ggsave("../Plots/primera_aplicacion/inhibicion.png")
```
...
ggsave("../Plots/primera_aplicacion/flexibilidad.png")
```
...
ggsave("../Plots/primera_aplicacion/socioemocionales_regulacion.png")
```
...
ggsave("../Plots/primera_aplicacion/socioemocionales_reconocimiento.png")
```
...
ggsave("../Plots/primera_aplicacion/socioemocionales_expresion.png")
```
...
write.xlsx(drop_na(alfa), "../Data/processed/primera_aplicacion/alfa.xlsx", row.names = FALSE)
```
...
write.xlsx(descriptivos, "../Data/processed/primera_aplicacion/descriptivos.xlsx", row.names = FALSE)
```
...
write.xlsx(indicadores_psicometricos,
           "../Data/processed/primera_aplicacion/indicadores_psicometricos.xlsx",
           row.names = FALSE)
```
...
write.xlsx(comparaciones,
           "../Data/processed/primera_aplicacion/pruebas_pre_post.xlsx",
           row.names = FALSE)
```
...
ggsave("../Plots/primera_aplicacion/pruebas_significativas.png")
```
...
ggsave("../Plots/primera_aplicacion/significativas_lenguaje.png")
```
...
ggsave("../Plots/primera_aplicacion/significativas_matematicas.png")
```
...
ggsave("../Plots/primera_aplicacion/significativas_motivacion.png")
```
...
ggsave("../Plots/primera_aplicacion/significativas_ejecutivas.png")
```
...
ggsave("../Plots/primera_aplicacion/significativas_socioemocionales.png")
```
...
ggsave("../Plots/primera_aplicacion/significativas_ciudades.png")
```
...
ggsave("../Plots/primera_aplicacion/significativas_ciclos.png")
```
