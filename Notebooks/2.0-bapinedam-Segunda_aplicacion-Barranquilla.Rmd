---
title: "Análisis de resultados: Segunda aplicación - Barranquilla"
output: 
  pdf_document:
    toc: yes
    toc_depth: 5
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/actitudes_lenguaje.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/actitudes_lenguaje_afectivo.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/actitudes_lenguaje_cognitivo.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/actitudes_lenguaje_conativo.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/actitudes_matematicas.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/actitudes_matematicas_afectivo.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/actitudes_matematicas_cognitivo.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/actitudes_matematicas_conativo.png")
```
...
Si bien el alfa del pre es bajo, en el post este sube
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/motivacion.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/motivacion_interes.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/motivacion_metas_aprendizaje.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/motivacion_AtribucionInterna.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/motivacion_expectativas.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/memoria_auditiva.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/memoria_visual.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/inhibicion.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/flexibilidad.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/socioemocionales_regulacion.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/socioemocionales_reconocimiento.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/socioemocionales_expresion.png")
```
...
write.xlsx(drop_na(alfa), "../Data/processed/Barranquilla/segunda_aplicacion/alfa.xlsx", row.names = FALSE)
```
...
write.xlsx(descriptivos, "../Data/processed/Barranquilla/segunda_aplicacion/descriptivos.xlsx", row.names = FALSE)
```
...
write.xlsx(indicadores_psicometricos,
           "../Data/processed/Barranquilla/segunda_aplicacion/indicadores_psicometricos.xlsx",
           row.names = FALSE)
```
...
write.xlsx(comparaciones,
           "../Data/processed/Barranquilla/segunda_aplicacion/pruebas_pre_post.xlsx",
           row.names = FALSE)
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/pruebas_significativas.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/significativas_lenguaje.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/significativas_matematicas.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/significativas_motivacion.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/significativas_ejecutivas.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/significativas_socioemocionales.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/significativas_ciudades.png")
```
...
ggsave("../Plots/Barranquilla/segunda_aplicacion/significativas_ciclos.png")
```
