---
title: "Análisis de resultados: Segunda aplicación - Cartagena"
output: 
  pdf_document:
    toc: yes
    toc_depth: 5
...
ggsave("../Plots/Cartagena/segunda_aplicacion/actitudes_lenguaje.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/actitudes_lenguaje_afectivo.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/actitudes_lenguaje_cognitivo.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/actitudes_lenguaje_conativo.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/actitudes_matematicas.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/actitudes_matematicas_afectivo.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/actitudes_matematicas_cognitivo.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/actitudes_matematicas_conativo.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/motivacion.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/motivacion_interes.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/motivacion_metas_aprendizaje.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/motivacion_AtribucionInterna.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/motivacion_expectativas.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/memoria_auditiva.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/memoria_visual.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/inhibicion.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/flexibilidad.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/socioemocionales_regulacion.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/socioemocionales_reconocimiento.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/socioemocionales_expresion.png")
```
...
write.xlsx(drop_na(alfa), "../Data/processed/Cartagena/segunda_aplicacion/alfa.xlsx", row.names = FALSE)
```
...
write.xlsx(descriptivos, "../Data/processed/Cartagena/segunda_aplicacion/descriptivos.xlsx", row.names = FALSE)
```
...
write.xlsx(indicadores_psicometricos,
           "../Data/processed/Cartagena/segunda_aplicacion/indicadores_psicometricos.xlsx",
           row.names = FALSE)
```
...
write.xlsx(comparaciones,
           "../Data/processed/Cartagena/segunda_aplicacion/pruebas_pre_post.xlsx",
           row.names = FALSE)
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/pruebas_significativas.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/significativas_lenguaje.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/significativas_matematicas.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/significativas_motivacion.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/significativas_ejecutivas.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/significativas_socioemocionales.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/significativas_ciudades.png")
```
...
ggsave("../Plots/Cartagena/segunda_aplicacion/significativas_ciclos.png")
```
